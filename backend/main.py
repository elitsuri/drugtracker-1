"""
DrugTracker 1 - Backend API
Medication tracking app with reminders, dosage history, and reports
"""
...
app = FastAPI(
    title="DrugTracker 1",
    description="Medication tracking app with reminders, dosage history, and reports",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "DrugTracker 1"}
